...
class ArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update article" do
    patch article_url(@article), params: { article: { collection_notes: @article.collection_notes, description: @article.description, images: @article.images, is_owner: @article.is_owner, location: @article.location, reactions: @article.reactions, section: @article.section, status: @article.status, title: @article.title, value: @article.value } }
